...
let { int, reloadPage, replace_ext, round, path_exists, $fadeOut, $fadeIn } = require("pyano_local_modules/util");
...
async function handleMov(movname, movpath) {
	...
	try {
		...
		await Alert.big.blocking({
			title: "Working...", html: "Please wait", showConfirmButton: false,
