...
async function showFailedTrialFeedback(animationPiano, levels, doneTrialResult, truth) {
	...
	if (advance_trial) {
		...
		if (_mistakeKind != null)
			_smallmsg += ` you had some ${_mistakeKind} mistakes`;

		if (tempo_str && tempo_str != 'ok') {
			if (_mistakeKind != null)
				_smallmsg += `, and you played too ${tempo_str}.`;
			else
				_smallmsg += ` you played too ${tempo_str}.`;
		} else {
			_smallmsg += '.';
		}
		...
		if (tempo_str && tempo_str != 'ok')
			_smallsec += `<br>Additionally, you played too ${tempo_str}.`;
