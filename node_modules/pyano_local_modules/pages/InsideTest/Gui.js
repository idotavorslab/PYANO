...
class Video {
    ...
    _setEventHooks(){
        ...
        for (const [evname, {description, loglevel}] of Object.entries(events)) {
            ...
            this[evFired] = false;
            this.vidElm[`on${evname}`] = (e) => {
                this[evFired] = true;
                console[loglevel](`${evname} fired: ${description} | ${e}`)
            };
        }
    }
    ...
    async play(numOfNotes, playbackRate) {
        ...
        console.log(`📽 concurrent: vide.play(), _promiseFadeIn(), wait(waitValue =`, waitValue);
        await Promise.all([this.vidElm.play(), this._promiseFadeIn(), asx.wait(waitValue)]);
