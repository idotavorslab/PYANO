...
async function playPreTrialDemo({ animationPiano, levels, truth }) {
	...
	$smallMessageSecondary.html(`Here's ${shouldAlsoRunVideo ? "a video" : "an animation"} showing only these <b>${currentLevel.notes}</b> notes. ${!currentLevel.rhythm ? '<br>You can play as slow as you like.' : ''}`);
