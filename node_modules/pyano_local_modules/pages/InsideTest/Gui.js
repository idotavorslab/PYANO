...
class Video {
	...
	_promiseFadeOut() {
		...
		return new Promise(resolve => this.$element.animate({ volume: 0 }, 100, resolve));
	}
	...
	async _getWaitValue(numOfNotes) {
		...
		if (numOfNotes == null) {
			...
			let relevant_pairs = this.on_off_pairs.slice(0, numOfNotes);
			debugger;
			...
			logData = {
				...logData,
				on_tdeltas,
				'only relevant messages': this.on_messages._msgs.slice(0, on_tdeltas.length),
	...
	async play(numOfNotes) {
		...
		try {
			console.log(...log('trying... (concurrent play, promiseFadeIn, waitValue)'));
			...
			console.log('%cFaking mousedown...', 'color:#de7d36');
			...
			console.log('%cDone faking mousedown. waiting 100ms...', 'color:#de7d36');
			await asx.wait(100);
			console.log('%cDone waiting 100ms', 'color:#de7d36');
