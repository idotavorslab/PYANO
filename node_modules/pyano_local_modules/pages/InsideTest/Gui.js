...
async function playPreTrialDemo(options) {
	...
	let { levelIndex, midi, numOfNotes, playbackPiano, trialIndex } = options;
...
async function showFailedTrialFeedback(options) {
	...
	let { midi, playbackPiano, trialIndex, mistakes, trialTruth } = options;
...
async function showPassedTrialFeedback(midi, playbackPiano, trialIndex, trialTruth) {
