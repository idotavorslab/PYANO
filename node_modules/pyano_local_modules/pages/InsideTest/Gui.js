...
/**@param {Piano} animationPiano
 ...
 @param {TMistake[]} mistakes
 @param {Truth} truth
 @return {Promise<void>}*/
async function showFailedTrialFeedback(animationPiano, currentLevel, mistakes, truth) {
	console.log(...logmod('showFailedTrialFeedback(animationPiano, currentLevel, mistakes, truth)', { b: true }));
