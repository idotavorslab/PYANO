...
/**@param {Piano} animationPiano
 ...
 @param {Truth} truth
 @return {Promise<void>}*/
async function playPreTrialDemo({ animationPiano, currentLevel, truth }) {
	console.log(...logmod('playPreTrialDemo(animationPiano, currentLevel, truth)', { b: true }));
	...
	// const currentLevel = EStore.getCurrentLevel();
	...
	$smallMessageSecondary.html(`Here's ${shouldAlsoRunVideo ? "a video" : "an animation"} showing only these <b>${currentLevel.notes}</b> notes.`);
	...
	if (shouldAlsoRunVideo) {
		await _runVideo(currentLevel.notes);
