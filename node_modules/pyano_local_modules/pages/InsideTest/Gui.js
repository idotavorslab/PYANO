...
async function showFailedTrialFeedback(animationPiano, levels, doneTrialResult, truth) {
	...
	$bigMessage.text("Oi vei...").addClass('lightpink');
	...
	const playbackRate = min(levels.getNextTempoOfThisNotes() / 100, EStore.currentTest().errors_playingspeed);
	let playOptions = {
		truth,
		animation,
		numOfNotes: mistakes.length,
		mistakes,
		animationPiano,
		playbackRate
	};
