...
async function playWholeTruthDemo(animationPiano, truth, maxNotesOfLevels) {
	console.log(...logmod('playWholeTruthDemo(userMidi, animationPiano, truth)'));
...
async function playPreTrialDemo(options) {
	...
	let { levelIndex, numOfNotes, animationPiano, trialIndex, truth } = options;
