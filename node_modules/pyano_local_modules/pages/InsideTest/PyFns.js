...
async function normalizeTxtFile(truth) {
	console.log(...log('normalizeTxtFile()'), truth);
	return await Python.runAsync('InsideTest/normalize_txt_file.py', { args: [truth.txt.on.path], mode: "json" });
