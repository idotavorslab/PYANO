		...
		*/
		...
		Python.run('InsideTest/check_done_trial.py', {
			...
			async (err, output) => {
				...
				let { passed, mistakes, played_enough_notes, played_too_many_notes, is_tempo_correct } = output[0];
				...
				resolve({ passed, mistakes, played_enough_notes, played_too_many_notes, is_tempo_correct });
