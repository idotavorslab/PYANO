...
class DoneTrialResult {
	...
	/**@return {?string}*/
	mistakesDescription() {
		if ('accuracy'.in(this.mistakes) && 'rhythm'.in(this.mistakes))
			return 'accuracy and rhythm';
		if ('accuracy'.in(this.mistakes))
			return 'accuracy';
...
function check_done_trial(truth, trialTruth) {
	...
	return new Promise((resolve, reject) => {
		...
		const { allowed_rhythm_deviation, allowed_tempo_deviation } = EStore.currentTest();
