...
/**@param {Midi} midi
 @param {Piano|Tone.AudioNode} animationPiano*/
async function playWholeTruthDemo(midi, animationPiano) {
...
/**@param {Midi} midi
 ...
 @param {Number} numOfNotes
 @return {Promise<void>}*/
async function playPreTrialDemo(midi, animationPiano, levelIndex, trialIndex, numOfNotes) {
...
/**@param {Midi} midi
 ...
 @return {Promise<void>}*/
async function showFailedTrialFeedback(midi, animationPiano, trialIndex, mistakes) {
...
/**@param {Midi} midi
 @param {Piano} animationPiano
 @param {Number} trialIndex*/
async function showPassedTrialFeedback(midi, animationPiano, trialIndex) {
