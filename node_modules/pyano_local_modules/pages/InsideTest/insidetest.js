...
let {
	$fadeIn, $fadeOut, $fadeOutMany, bool,
...
async function _runTrial(midi, playbackPiano) {
	...
	await midi.newOnOffTxtWriteStreams(`${trialFilePathNoExt}.txt`);
...
async function _handleDoneTrial(midi, playbackPiano, trialFilePathNoExt) {
	...
	await midi.endOnOffTxtStreamsAndWriteMidi(messages, `${trialFilePathNoExt}.mid`);
