...
async function onSubmitSubjectClick() {
	...
	EStore.config().current_subject = subjectIdInputVal;
	...
	const subjectsList = EStore.config().getSubjectDirNames();
	EStore.set('subjects', subjectsList);
	if (!(subjectsList.includes(EStore.config().current_subject)))
