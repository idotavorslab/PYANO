...
const LevelsPart = (() => {
	...
	$removeLevelBtn.activate = function (self) {
		console.log({ self });
		$removeLevelBtn.toggleClass('inactive-btn', false).toggleClass('active-btn', true);
	};
	$removeLevelBtn.deactivate = () => $removeLevelBtn.toggleClass('inactive-btn', true).toggleClass('active-btn', false);
	...
	function removeLevel() {
		...
		const noZeroes = levelsArr.hasNoZeroes();
		Gui.toggleButtons(noZeroes);
		// TODO: if no levels: deactivate remove
	...
	function toMode(mode) {
		...
		$addLevelBtn.toggleClass('inactive-btn', toTempoMode).toggleClass('active-btn', !toTempoMode);
		if (toTempoMode) {
			_reset();
			$addLevelBtn.click();
		}
