...
const LevelsPart = (() => {
	class LevelsArray {
		...
		_rawValuesPairs() {
			...
			console.log('_rawValuesPairs()', { ret });
			return ret;
		}
	...
	function removeLevel() {
		...
		console.log({ row, 'levelsArr.length before pop': levelsArr.length, 'levelsArr.hasNoZeroes()': levelsArr.hasNoZeroes() });
		let last = levelsArr.pop();
		console.log({ 'levelsArr.length AFTER pop': levelsArr.length, 'levelsArr.hasNoZeroes()': levelsArr.hasNoZeroes() });
