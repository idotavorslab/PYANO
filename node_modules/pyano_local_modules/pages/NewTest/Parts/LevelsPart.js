...
const LevelsPart = (() => {
	...
	class $Level {
		...
		constructor(row, levelIndex, right = 0) {
			...
			this.$notesSelect = this._$constructNotesSelect(baseGridColumn, levelIndex);


			this.$rhythmSwitch = this._$constructRhythmSwitch(baseGridColumn);


			this.$tempoSelect = this._$constructTempoSelect(baseGridColumn);
		 ...
		 * @return {jQuery}
		 * @private*/
		_$constructTempoSelect(baseGridColumn) {
			let _$tempoSelect = $('<select disabled class="my-select my-select-disabled">', "select")
				.css({
		 ...
		 * @return {jQuery}
		 * @private*/
		_$constructRhythmSwitch(baseGridColumn) {
			return $('<button class="my-btn toggle-btn-off">', "toggle")
				.css({
		 ...
		 * @return {jQuery}
		 * @private*/
		_$constructNotesSelect(baseGridColumn, levelIndex) {
			...
			if (levelIndex >= 1)
				_$notesSelect.val(int(levelsArr.get(levelIndex - 1).$notesSelect.val()) + 1);
