...
const LevelsPart = (() => {
	...
	let $removeLevelBtn = $('<button id="levels_remove_level_btn">')
		...
		.html('Remove Level')
		.click(removeLevel);
	$removeLevelBtn.activate = ()=>$removeLevelBtn.toggleClass('inactive-btn',false).addClass('active-btn',true);
	$removeLevelBtn.deactivate = ()=>$removeLevelBtn.toggleClass('inactive-btn',true).addClass('active-btn',false);
