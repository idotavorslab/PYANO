...
const $$ = e => {
	let $e = $(e);
	$e.activate = () => $e.toggleClass('inactive-btn', false).toggleClass('active-btn', true);
	$e.deactivate = () => $e.toggleClass('inactive-btn', true).toggleClass('active-btn', false);
	$e.toggle = (on) => on ? $e.activate() : $e.deactivate();
	return $e;
};
let Gui = require("../Gui");
...
const LevelsPart = (() => {
	class LevelsArray {
		...
		isEmpty() {return !bool(this.notesTrialsTupleList());}

		hasNoZeroes() {
			if (this.isEmpty())
				return false;
			if (EStore.isLearningTempo())
				return this.notesTrialsTupleList().every(
	...
	function toMode(mode) {
		...
		try {
			...
			if (!(e instanceof TypeError)) {
				Alert.small.error("Failed changin learning type", e.message);
				throw e;
			}
