...
class MyStore extends Store {
	...
	setLastPage(page) {
		if (!page.in(['new_test', 'inside_test', 'record', 'video_tools', 'settings']))
			throw new Error(`setLastPage(page = ${page}), can be either ['new_test','inside_test','record','video_tools','settings']`);
