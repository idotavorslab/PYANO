...
class MyStore extends Store {
	...
	set experiment_type(type) {
		if (type != 'test' && type != 'exam')
			throw new Error(`MyStore experiment_type setter, got type: '${type}'. Must be either 'test' or 'exam'`);
		return this.set('experiment_type', type);
	}
...
class Config extends MyStore {
	...
	toObj() {
		return super.get(`current_${this.mode}`);
	}
