...
class MyStore extends Store {
	...
	setSubjectsFromDirectories(){
		this.subjects = require("fs").readdirSync(Path.join(super.get('root_abs_path'), 'experiments', 'subjects'));
	}
	/**@return {string}*/
	configsPath() {
...
class Config extends MyStore {
	...
	set current_subject(name) {
		...
		// super.set('subjects', [...new Set([...super.get('subjects'), name])]);
			super.subjects = [...super.subjects, name];
	}
