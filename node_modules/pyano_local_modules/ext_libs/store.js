...
class Config extends EventEmitter {
	...
	get allowed_rhythm_deviation() {
		return this._config.allowed_rhythm_deviation;
	}

	get allowed_tempo_deviation() {
		return this._config.allowed_tempo_deviation;
	}

	get current_subject() {
		return this._config.current_subject;
	}

	get demo_type() {
		return this._config.demo_type;
	}

	get errors_playingspeed() {
		return this._config.errors_playingspeed;
	}

	get finished_trials_count() {
		return this._config.finished_trials_count;
	}
	...
	set levels(_levels) {
		this.emit('set_levels', _levels);
	}

	get truth_file_path() {
		return this._config.truth_file_path;
	}
...
class MyStore extends Store {
	...
	currentConfig() {
		const _currentConfig = new Config(this.get(`current_${this.mode}`));
		_currentConfig.on('set_levels', _levels => this.set(`current_${this.mode}.levels`, _levels));
		return _currentConfig;
	}

	zeroFinishedTrialsCount() {
