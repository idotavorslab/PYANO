...
class MyStore extends Store {
	...
	*/
	...
	set experiment_type(experimentType) {
		...
		this.updateSavePathFile('experiment_type', experimentType);
...
class Config extends MyStore {
	...
	_set(keyOrObj, value) {
		...
		if (type === 'string') {
			...
			super.updateSavePathFile(_key, value);
			return;
		}
		if (type === 'object') {
			...
			for (const key in keyOrObj) {
				...
				super.updateSavePathFile(_key, keyOrObj[key]);
			}
