...
function build() {
	...
	for (let [i, [eid, human]] of enumerate(sidebarDict.items())) {

		let gridRow = str(i + 1);
		let id = `sidebar_${eid}`;
		sidebarItems.push($(span(human))
			.addClass(`sidebar-item ${eid == "home"
...
function to_home() { selectSidebarItem('sidebar_home', { changeTitle: true }); }

function to_config() { selectSidebarItem('sidebar_config', { changeTitle: true }); }
...
module.exports = { build, to_record, to_new_test, to_home, to_config, to_inside_test };
