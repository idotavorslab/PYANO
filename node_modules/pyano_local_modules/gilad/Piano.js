...
class Piano extends Tone.AudioNode {
	...
	constructor(localSamplesPath, ...args) {
		...
		console.log(`Piano constructor, localSamplesPath: ${localSamplesPath}`);
	...
	async load(url = this._localSamplesPath) {
		...
		//console.log(`this._harmonics: ${this._harmonics}. this._release: ${this._release}`)
		if (this._harmonics) {
		...
		console.log('%cPiano.js loaded', 'color:#278b3e');
		this._loaded = true;
	}
