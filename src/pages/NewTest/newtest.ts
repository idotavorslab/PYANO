...
import { EStore } from "../../ext_libs.js";
import * as util from "../../util.js"

import { Sidebar } from "../../sidebar.js";
import { MainContent } from "../../renderer.js";
...
const newTestPage = {
    ...
    switch: async reload => {
        ...
        await util.$fadeOut(MainContent, 100);
        MainContent.empty();
        MainContent.on({
        ...
        await util.$fadeInMany(150, Sidebar, MainContent);
        ...
        /*setInterval(() =>
            require('electron').remote.powerMonitor.getSystemIdleTime(time => {
                if (!triviaShown && time == 20) {
                    ...
                    Alert.small._question({
                        title: 'Did you know?',
                        text: trivias[util.round(Math.random() / (1 / trivias.length))],
                        timer: null,
